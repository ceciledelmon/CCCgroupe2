...
var createController = function ($scope, $timeout, $http, $location) {
    ...
    document.addEventListener("deviceready", function () {
        ...
        $scope.takePicture = function (index) {
            ...
            image.src = "http://lpcm.univ-lr.fr/~mlemetay/CCCPhoto/uploads/12674574.jpg";
            image.title = 2;
    ...
    $scope.sendImg = function (evt) {
            ...
            var params = JSON.stringify({"index" : 2, "keyFr" : 'chat', 'keyEn1' : 'cat', 'keyEn2' : 'kitten', 'name' : '12674574'});
